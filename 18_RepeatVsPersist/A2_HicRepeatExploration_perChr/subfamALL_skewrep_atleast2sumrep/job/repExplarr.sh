...
R --vanilla < /project/sahakyanlab/ltamon/DPhil/GenomicContactDynamics/4_RepeatVsPersist/A2_HicRepeatExploration/subfamALL_skewrep_atleast2sumrep/script/repExpl${SLURM_ARRAY_TASK_ID}.R
