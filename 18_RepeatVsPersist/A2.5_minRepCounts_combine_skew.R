...
# Age rank identifier
out.name = paste0(rep.group, metric) #"subfamALL_minRepCounts" #paste0(rep.group, metric) #paste0(rep.group, metric) #"subfamALL_minRepCounts" #"GiorPubl_minRepCounts"
plotOnly = TRUE
...
PREELMTISSDYN.MX <- makeMinRepPlot(MINREPCOUNTS, ntis.v, out.dir, nCPU=nCPU, metric=metric,
                                   affix=paste0("chrALL_", gcb, "_", out.name), generatePREELMTISSDYNonly=TRUE)

save(PREELMTISSDYN.MX, file=paste0(out.dir, "/chrALL_", gcb, "_", filterMINREPCOUNTSagerank.id, "_PreElmTissDyn.RData"))
