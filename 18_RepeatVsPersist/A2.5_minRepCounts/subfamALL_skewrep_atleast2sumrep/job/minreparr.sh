...
R --vanilla < /project/sahakyanlab/ltamon/DPhil/GenomicContactDynamics/4_RepeatVsPersist/A2.5_minRepCounts/subfamALL_skewrep_atleast2sumrep/script/minrep${SLURM_ARRAY_TASK_ID}.R
