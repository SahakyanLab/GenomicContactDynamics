...
maskfile = paste0(wk.dir, "/D3_binBaseContent/masking/maskfile/maskfile1")
out.dir = paste0(data.dir, "/HiC_features_GSE87112_RAWpc/out_binBaseContent/maskfile1")
### OTHER SETTINGS #############################################################
gcb = "min2Mb"
chr.v = "chr20"
bin.len = 4e4L
...
#maskLimit = 0.5
maskingChar = "m" # "m" | NULL; If maskingChar is NULL, no masking.
################################################################################
