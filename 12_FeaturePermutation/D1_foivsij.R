...
if( !is.null(whorunsit[1]) ){
  ...
  if(whorunsit == "LiezelMac"){
    ...
    wk.dir = "/Users/ltamon/DPhil/GenomicContactDynamics/20_ChromFeatAssoc_v1"
...
#foifile = paste0(wk.dir, "/foifile/foivsij/foifile_ABcomp_FC")
foifile = paste0(wk.dir, "/foifile/foivsij/foifile_LMNB1_FC")
...
Ct.v = c("Co", "Hi", "Lu", "LV", "RV", "Ao", "PM", "Pa", "Sp", "Li", 
         ...
         "FC", "LC")
out.id = "LMNB1_FC" #"ABcomp_FC" "LMNB1_FC" 
...
out.name <- paste0(gcb, "_", ct, "_", out.id, "_", type.olap)
...
if(plotOnly==FALSE){
  ...
  for(chr in chr.v){
    ...
    ubin.grp[ as.character(promisc.bin) ] <- "promi"
    ...
    for(Cp in Cp.v){
      ...
      FEATVSCP.MX[Cp, c("All", names(v))] <- FEATVSCP.MX[Cp, c("All", names(v))] + c(sum(cp.TF), v)
      rm(v, Cp)
    }
