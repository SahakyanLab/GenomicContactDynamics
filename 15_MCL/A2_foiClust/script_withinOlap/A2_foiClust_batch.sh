...
# Chr array
array1=($(seq 1 1 23))
#declare -a array1=("chr1" "chr2" "chr3" "chr4" "chr5" "chr6" "chr7" "chr8" "chr9" "chr10" "chr11" "chr12" "chr13" "chr14" "chr15")
prefix="chr"
# Cp array
#array2=($(seq 1 1 21))
#declare -a array2=(6 7 8 9)
array2=($(seq 1 1 10))
srcfile="/Users/ltamon/DPhil/GenomicContactDynamics/21_MCL/A2_foiClust/script/A2_foiClust.R"
###################################################################################
