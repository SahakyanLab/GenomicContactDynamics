...
if( !is.null(whorunsit[1]) ){
  ...
  if(whorunsit == "LiezelMac"){
    ...
    data.dir = "/project/sahakyanlab/ltamon/Database"
    wk.dir = "/project/sahakyanlab/ltamon/SahakyanLab/GenomicContactDynamics/13_Simulation"
  } else {
...
Cs.norm.dir = Cp.dir = paste0(data.dir, "/human_hg38_contacts/combined_contacts_50kb/KRoe")
...
out.dir = paste0(wk.dir, "/out_contactMxGap_hg38_50kb")
### OTHER SETTINGS #############################################################
gcb = "min2Mb"
chr = "chrCHRREPLACE"
ct.v = sort(c("ESC", "HFFc6", "LC"))
bin.len = 50000
species.id = "human"
...
X <- foreach(itr=isplitVector(1:ct.v.len, chunks=nCPU), 
  ...
  chunk <- sapply(X=itr, simplify=FALSE, FUN=function(i){
    ...
    df <- getContactDF(metric.dir=metric.dir, metric=metric,
                       ...
                       chrlen.file=chrLenfile, bin.len=bin.len, 
