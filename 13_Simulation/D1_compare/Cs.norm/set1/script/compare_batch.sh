...
array2=(SIM.int.set1.1.0 SIM.int.set1.1.5 SIM.int.set1.2.0 SIM.int.set1.3.0)
array3=(Cs.norm)
arrID=(ct subj ref)
srcfile="/Users/ltamon/DPhil/GenomicContactDynamics/21_Simulation/B1_compare/Cs.norm/set1/script/compare_template.R"
