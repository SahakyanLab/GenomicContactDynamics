...
array2=(SIM.int.set2.1.0 SIM.int.set2.1.5 SIM.int.set2.2.0 SIM.int.set2.3.0)
array3=(Cs.norm)
arrID=(ct subj ref)
srcfile="/Users/ltamon/DPhil/GenomicContactDynamics/21_Simulation/B1_compare/Cs.norm/set2/script/compare_template.R"
