...
out.dir = paste0(wk.dir, "/out_mutCalcPerBin_test")
...
mut.v = "C>T" 
#c("All", "C>A", "C>G", "C>T", "T>A", "T>C", "T>G")

# Should match levels of ncv.df$location 
loc.v = "exon_intron_intergenic_intergenic.excl" #c("exon", "intron", "intergenic", "intron_intergenic", 
...
SIG.v = c("RefSig.MMR1", "RefSig.MMR2") #c("RefSig.MMR1_RefSig.MMR2", colnames(sigExposure.df)[colnames(sigExposure.df)!="alt.ID"])
