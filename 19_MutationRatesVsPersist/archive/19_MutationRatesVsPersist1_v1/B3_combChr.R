...
feta.dir = paste0(wk.dir, "/out_mutPerBinSiteperChr")
out.dir = paste0(wk.dir, "/out_combChr")
...
foreach(itr=isplitVector(1:foi.v.len, chunks=nCPU), .inorder=FALSE, 
  ...
  for(i in itr){
    ...
    save(FETACP.MX, file=paste0(out.dir, "/chrALL_", gcb, "_", celltiss, "_", 
                                foi, "_mutation_fetacp.RData"))
