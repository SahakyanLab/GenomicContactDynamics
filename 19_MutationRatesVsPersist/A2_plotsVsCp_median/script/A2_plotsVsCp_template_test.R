...
out.dir = paste0(wk.dir, "/out_plotsVsCp_test")
...
calc = "Nmsitenorm" #"arr1.repl" 
aggregatefunx = "median" # String of a function name e.g. "mean", "median"

#-------------------Per plot

mut.v = "C>G" #"arr2.repl" #c("All", "C>A", "C>G", "C>T", "T>A", "T>C", "T>G")
...
SIG.v = "RefSig.3" #c("RefSig.MMR1_RefSig.MMR2", 
        #  colnames(sigExposure.df)[colnames(sigExposure.df)!="alt.ID"])

#-------------------Combined in one plot

# Should match levels of ncv.df$location 
loc.v = "exon" #c("exon", "intron", "intergenic", "intron_intergenic", 
        #  "exon_intron_intergenic_intergenic.excl")

sigEpLim.v = "50_100" #c("nosampfilter", "-1_0", "10_100", "30_100", "50_100") 
