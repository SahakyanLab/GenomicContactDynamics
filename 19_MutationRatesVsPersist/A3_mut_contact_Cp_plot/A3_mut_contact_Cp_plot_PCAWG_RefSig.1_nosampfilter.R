...
mut.calcs = c("Tmutnorm", "Nmsitenorm", "TmutDIVNmsite")[[1]]
mut.types = c("All", "C>A", "C>G", "C>T", "T>A", "T>C", "T>G")[[1]]
mut.types = gsub(">", "To", mut.types, fixed=T)[[1]]
mut.locs = c("exon", "intron", "intergenic", "intron_intergenic", "exon_intron_intergenic_intergenic.excl")[[1]]
