...
out.dir = paste0(wk.dir, "/out_mut_contact_Cp_plotdata_ICGC_RefSig.1_nosampfilter")
### OTHER SETTINGS #############################################################
chr = "chrCHRREPLACE" #chrs = paste0("chr", c(21:22))
#nCPU = 1
persist.id = "Persist_min2Mb"
src.file.pattern = c("donor_centric_ICGC_Hg19", "RefSig.1_", "sigEperclimits_nosampfilter_" , 
