...
out.dir = paste0(wk.dir, "/out_constraints_kmer3")
...
binkmer.dir = paste0(data.dir, "/HiC_features_GSE87112_RAWpc/binkmer3_divLen_all")
### OTHER SETTINGS #############################################################
# both
gcb = "min2Mb"
chr.v = "chrREPLACE" #paste0("chr", c(22:1, "X"))
bin.len = 4e4L
kmer.len = 3L
