...
array1=($(seq 1 1 8)) #arr1.repl, note that if array1 has 23 --> X, disable this if
# array1 is not for chr
prefix1="chr"
array2=(kmer align)  #arr2.repl
prefix2="type"
srcfile="/Users/ltamon/DPhil/GCD_polished/11_Complementarity/B2_getConstraints/dme_script/B2_getConstraints_template.R"
###################################################################################
