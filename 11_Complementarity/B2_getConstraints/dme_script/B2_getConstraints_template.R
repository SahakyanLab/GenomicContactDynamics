...
out.dir = paste0(wk.dir, "/out_constraints_dme_10kb")
persist.dir = paste0(data.dir, "/HiC_features_drosophila_dm6_RAWpc/features_10kb")
# File with chromosome lengths (use right genome build), Columns: chromosome-length.bp
chrLenfile = paste0(data.dir, "/genome_info/Dme_dm6_chr_info.txt")
# align
genome.dir = paste0(data.dir, "/drosophila_genome_unmasked_dm6")
# kmer
gfreepar.dir = paste0(data.dir, "/HiC_features_GSE87112_RAWpc")
binkmer.dir = paste0(data.dir, "/HiC_features_drosophila_dm6_RAWpc/binkmer7_divLen_all_10kb")
### OTHER SETTINGS #############################################################
# both
gcb = "min0Mb"
chr.v = paste0("chr", c("X", "2L", "2R", "3L", "3R", "4", "Y", "MT"))[arr1.repl]
bin.len = 10000 #2000 #4e4L
kmer.len = 7
...
genome.prefix = "Drosophila_melanogaster.dm6.dna.chromosome." #"Homo_sapiens.GRCh37.73.dna.chromosome." 
fastafile.ending = ".fa"
################################################################################
...
source(paste0(lib, "/getComplementarity_nopersist.R"))
