...
gcb = "min2Mb"
chr = "chr22"
type.v = c("align", "kmer", "Gfree", "sdDifference")
mult.v = setNames(c(1, 1, 1, 10^4), nm=type.v) # Multiplier before doing test, for less memory usage
affix = ""
gap.rng = list(c(50,50), c(50,100))[[1]] # j - i - 1, closed range, Set to NULL if not filtering
################################################################################
