...
out.dir = paste0(wk.dir, "/out_constraints_ath_20kb")
...
binkmer.dir = paste0(data.dir, "/HiC_features_arabidopsis_HiC_NORMpc/binkmer7_divLen_all_20kb")
### OTHER SETTINGS #############################################################
# both
gcb = "min0Mb"
chr.v = paste0("chr", c(5, 1))
bin.len = 20000 #2000 #4e4L
kmer.len = 7
...
nCPU = 1 # chr1 - 4L, chr21 - 2L
allij = TRUE
# align
numChunks = 8 # human chr1 - 32L, chr21 - 2L
gfreeparfile = paste0(gfreepar.dir, "/Gfree_", kmer.len, "mer.par")
genome.prefix = "Arabidopsis_thaliana.TAIR10.dna.chromosome." #"Homo_sapiens.GRCh37.73.dna.chromosome." 
fastafile.ending = ".fa"
################################################################################
