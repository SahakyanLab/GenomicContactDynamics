...
Rscript --vanilla /t1-data/user/ltamon/DPhil/GenomicContactDynamics/20_ChromFeatAssoc/C1_associate/maskOlaptest/resample/script/assocResample${SGE_TASK_ID}.R
