################################################################################
# Association of RS with features
################################################################################
...
out.dir = paste0(wk.dir,"/out_associate_masktest_random")
### OTHER SETTINGS #############################################################
gcb = "min2Mb"
...
allCT.ref = "allCT"
Cs.v = c(0.01, 1) # Depends on BIN.MX values; 1-Bin forms contact; 5-Bin part of top 5%
id = "CptopCP3" # c("Cp21", "CptopCP3", "Cp1", "CpAll", "CpAllCs1perc", "CpAllCsmatch")
...
source(paste0(wk.dir, "/lib/permute_random.R"))
################################################################################
