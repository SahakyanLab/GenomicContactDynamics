...
if( !is.null(whorunsit[1]) ){
  ...
  if(whorunsit == "LiezelMac"){
    ...
    wk.dir = paste0(home.dir, "/DPhil/GCD_polished/7_FeaturePermutation")
    os = "Mac"
...
foifile = paste0(wk.dir, "/C1_associate/foifile/foifile844")
mask.dir = paste0(wk.dir, "/mask")
binmx.dir = paste0(wk.dir, "/binmx/out_bindata_1perc_HiCNorm")
out.dir = paste0(wk.dir,"/out_associate_CptopCP3")
### OTHER SETTINGS #############################################################
gcb = "min2Mb"
