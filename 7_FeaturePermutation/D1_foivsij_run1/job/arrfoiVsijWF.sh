...
Rscript --vanilla /t1-data/user/ltamon/DPhil/GenomicContactDynamics/20_ChromFeatAssoc/D1_foivsij/script/within_query_foi/foivsij${SLURM_ARRAY_TASK_ID}.R
