...
out.dir = paste0(wk.dir, "/out_eq_mapToPersistBins_anno")
### OTHER SETTINGS #############################################################
featurefile.v = paste(feat.dir, c("/hg19annoEqTrLen_ave_ALL", "/hg19annoEqTrLen_m2sd_ALL", 
                                  "/hg19anno_ALL"), sep="")
# Output identifier; should correspond with featurefile.v
out.name.v = c("ALL_EqTrLen_ave_hg19_40KbBinAnno", "ALL_EqTrLen_m2sd_hg19_40KbBinAnno",
               "ALL_EqTrLen_hg19_40KbBinAnno")
# HiC res
bin.len = 40000L
# Path to file
